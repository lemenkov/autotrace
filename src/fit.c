// SPDX-FileCopyrightText: 1992 Free Software Foundation, Inc.
//
// SPDX-License-Identifier: GPL-2.0-or-later

/* fit.c: turn a bitmap representation of a curve into a list of splines. Some
 * of the ideas, but not the code, comes from the Phoenix thesis.  See README
 * for the reference.
 *
